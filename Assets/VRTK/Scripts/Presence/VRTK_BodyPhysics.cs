...
namespace VRTK
{
    ...
    public class VRTK_BodyPhysics : VRTK_DestinationMarker
    {
        ...
        {
            if (!playArea.transform.position.Equals(lastPlayAreaPosition))
            {
        ...
        private void SetIsMoving(Vector2 currentHeadsetPosition)
        {
            ...
            if (!playArea.transform.position.Equals(lastPlayAreaPosition) || !onGround)
            {
                isMoving = false;
            }
        }
        ...
        private void CheckLean()
        {
            ...
            Vector3 standingDownRayStartPosition = new Vector3(currentStandingPosition.x, headset.position.y, currentStandingPosition.y);
            Ray standingDownRay = new Ray(standingDownRayStartPosition, -playArea.up);
        ...
        private void CheckHeadsetMovement()
        {
            ...
            var currentHeadsetPosition = new Vector2(headset.position.x, headset.position.z);
